...
<Table
  title="JAMstack responsibilities"
  caption="The acronym distinguishes client-side JavaScript, API routes, and pre-rendered markup."
>
  <THead>
    <TR>
      <TH>Role</TH>
  ...
  <TBody>
    <TR>
      <TD>J</TD>
      <TD>Client-side JavaScript injected through React Hooks, including state, event listeners, and effects.</TD>
    </TR>
    <TR>
      <TD>A</TD>
      <TD>API pages inside the <code>pages/api</code> directory.</TD>
    </TR>
    <TR>
      <TD>M</TD>
      <TD>Pages with no data dependencies, or static data dependencies that trigger build-time static site generation.</TD>
    </TR>
  </TBody>
</Table>
...
<Bibliography>
  <BibliographyItem
    ...
    note="Author&apos;s synthesis of operational tradeoffs; no primary keynote recording is linked."
  />
  <BibliographyItem
    id="critical-pages"
    label="[2]"
    title="Precomputing critical pages"
    note="Author guidance on staged static generation; not an external source."
  />
  <BibliographyItem
    id="static-security"
    label="[3]"
    title="Static delivery and security"
    note="Author&apos;s synthesis of static-delivery security implications; not an external source."
  />
  <BibliographyItem
    id="cosmos-db"
    label="[4]"
    title="Cosmos DB"
    note="Product description based on the author&apos;s infrastructure experience."
  />
  <BibliographyItem
    id="ios-viewport"
    label="[5]"
    title="iOS viewport behavior"
    note="Author observation of iOS Safari viewport behavior."
  />
  <BibliographyItem
    id="platform-stdlib"
    label="[6]"
    title="Platform standard libraries"
    note="Author comparison of standard-library tradeoffs; not a formal source."
  />
  <BibliographyItem
    id="swr-ergonomics"
    label="[7]"
    ...
    note="Author comparison of SWR and Redux ergonomics."
  />
</Bibliography>
