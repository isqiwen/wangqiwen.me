...
<Image
  alt="Martin Fowler's conventional testing pyramid. What if latency and cost constraints went away?"
...
<Image
  alt="An example of a pull request automatically deployed for this blog"
...
always contains the string "Wang Qiwen" in the browser title. As I'm
...
changes to `wangqiwen.me` automatically.
