export const metadata = {
  ...
  "description": "Reflecting on the joy and lessons of code golf competitions and hacking challenges.",
...
The main reason is that there wasn't a particular instant, or month, or year, or flow state I got in where I finally learned to code. It was more of a _discontinuous_ process full of ups, downs, impostor syndrome, months of voracious learning, followed by [months of entertaining distractions](https://twitter.com/dan_abramov/status/1233812773282422784?lang=en).
...
<Callout type="note" title="Spoiler">
  I'm detailing the solution to one of the code challenges.
</Callout>

Equipped with `print`, I was able to enumerate the entire environment<Citation refId="figma-realms" label="[1]" />.
...
My solution used **27** characters, and _primo_ had somehow found a solution with just **24**.
...
Unfortunately, it used **30** characters, but I was encouraged by the existence of another path to a solution <Citation refId="continuous-integration" label="[2]" />. I fired up [Notion](/2020/2019-in-review#notion-is-fancy) and started documenting my attempts.
...
With those two characters gone, I cemented my one and only contribution to the annals of code-golf.io as the permanent _4th 1st-place_ 😅:
...
<Bibliography>
  ...
  >
    In the very minimal list returned, I found `Realm`, which provides a clue
    about how sandboxing might have been implemented by the game.
  </BibliographyItem>
  <BibliographyItem
  ...
  >
    Much like with CI, green just… feels good.
  </BibliographyItem>
</Bibliography>
