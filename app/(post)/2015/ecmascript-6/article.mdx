...
For the past few months I’ve been exclusively writing ECMAScript 6 code by taking advantage of transpilation <Citation refId="transpilation-terminology" label="[1]" /> to a currently supported version of JavaScript.
...
<Bibliography>
  <BibliographyItem
    id="transpilation-terminology"
    label="[1]"
    title="On the term “transpilation”"
    links={[
      {
        label: "Discussion",
        href: "https://twitter.com/fogus/status/550717447163355136",
      },
    ]}
  >
    I use the word “transpilation” throughout the article on the basis of its
    popularity to refer to JavaScript source-to-source compilation. The merits
    of the term are technically debatable.
  </BibliographyItem>
</Bibliography>
