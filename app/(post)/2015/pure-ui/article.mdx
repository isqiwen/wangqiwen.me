...
<Bibliography>
  <BibliographyItem
    ...
    note="Author&apos;s analysis of why programming models can matter more than feature comparisons."
  />
  <BibliographyItem
    id="artboards"
    label="[2]"
    ...
    note="Background summary; linked vendor documentation provides the primary product descriptions."
  />
</Bibliography>
