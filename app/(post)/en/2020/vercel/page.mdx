export const metadata = {
  ...
  alternates: {
    languages: {
      'en': 'https://wangqiwen.xyz/2020/vercel',
      'ja': 'https://wangqiwen.xyz/ja/2020/vercel'
    }
  }
}
...
If you’re creating a modern frontend nothing matters more than great site performance for the user. [Google’s Lighthouse score](https://twitter.com/QiWenWang1/status/1252312827131342848), for example, is measuring your frontend performance across multiple dials that are going to greatly influence your SEO ranking.
